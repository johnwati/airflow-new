...
db_url = 'mysql+mysqlconnector://your_username:your_password@your_host/TeaGrowersDB'
...
def insert_data_from_excel(url):
    try:
        ...
        # above line ensures that any NaN values in the dataframe are converted to None for insertion into the database
