...
def create_table(cursor):
    ...
    create_table_query = """
    CREATE TABLE IF NOT EXISTS tea_growers_py (
        ...
        Total_Tea_Bushes INT,
        Age_of_the_Tea_Bush FLOAT,
        Productivity_per_Bush FLOAT,
        Type_of_Farming VARCHAR(255),
        Membership_in_Tea_Association VARCHAR(255),
        Total_Fertilizer_Per_Year_Acre FLOAT,
        Average_Annual_Tea_Production FLOAT,
        Payment_Method VARCHAR(255),
        Date_Greenleaf_Agreement_Signed DATE
    )
    """
...
def insert_data(cursor, df):
    ...
    insert_query = """
    INSERT INTO tea_growers_py (
        Grower_Number, Grower_Name, NationalID, Grower_Group, Company_Registration_Certificate_No, CompanyPIN, Gender, Date_of_Birth,
        TEl_Number, Email, Land_Registration_No, Total_Land_Area, Tea_Cultivation_Area, Factory, Buying_Centre, Ward_Location,
        Sub_County, County, Regionid, Tea_Varieties_Cultivated, Tea_Cultivars, Total_Tea_Bushes, Age_of_the_Tea_Bush, Productivity_per_Bush,
        Type_of_Farming, Membership_in_Tea_Association, Total_Fertilizer_Per_Year_Acre, Average_Annual_Tea_Production, Payment_Method,
        Date_Greenleaf_Agreement_Signed
